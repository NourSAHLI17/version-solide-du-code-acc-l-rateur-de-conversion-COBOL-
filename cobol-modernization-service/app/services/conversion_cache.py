"""File-based conversion result cache keyed by program name + COBOL source hash."""
...
CACHE_DIR = SERVICE_ROOT / ".conversion_cache"
CACHE_VERSION = "v5"


def get_cache_key(program_name: str, source: str) -> str:
