...
f2 = '''# COBOL Modernization Pipeline — Hybrid Parser Architecture
...
with open("output/G2_hybrid_parser_architecture.md", "w", encoding="utf-8") as f:
    f.write(f2)
print(f"G2: {len(f2):,} chars")
