# COBOL Modernization Pipeline — Problems Faced & How They Were Solved
...
2. The real grammar was generated into Python artifacts:
   ```bash
   antlr4 -Dlanguage=Python3 -visitor -listener      -o app/parsers/generated/      grammars_v4_master/cobol85/Cobol85.g4
   ```
