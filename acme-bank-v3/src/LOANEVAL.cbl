      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           ...
           SELECT GUARANTEE-FILE
               ...
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS GTR-ID
               ALTERNATE RECORD KEY IS GTR-LOAN-ID
                   WITH DUPLICATES
      ...
      *================================================================
       0500-CLOSE-FILES.
           CLOSE LOAN-FILE CUSTOMER-FILE COLLATERAL-FILE
                 GUARANTEE-FILE SCORE-FILE DECISION-REPORT REJECT-LOG.
      ...
      *================================================================
       3000-LOAD-COLLATERAL.
           ...
           MOVE WS-CURRENT-LOAN-ID TO COL-LOAN-ID
           START COLLATERAL-FILE KEY = COL-LOAN-ID
               INVALID KEY CONTINUE
               NOT INVALID KEY
                   MOVE 'Y' TO WS-COLLATERAL-FOUND
                   PERFORM 3010-SUM-COLLAT
                       UNTIL WS-COL-FS NOT = '00'
                       OR COL-LOAN-ID NOT = WS-CURRENT-LOAN-ID
           END-START.
      ...
      *================================================================
       3100-LOAD-GUARANTEES.
           ...
           MOVE WS-CURRENT-LOAN-ID TO GTR-LOAN-ID
           START GUARANTEE-FILE KEY = GTR-LOAN-ID
               INVALID KEY CONTINUE
               NOT INVALID KEY
                   MOVE 'Y' TO WS-GUARANTEE-FOUND
                   PERFORM 3110-SUM-GUARANTEES
                       UNTIL WS-GTR-FS NOT = '00'
                       OR GTR-LOAN-ID NOT = WS-CURRENT-LOAN-ID
           END-START.
      ...
      *================================================================
       6000-WRITE-SCORE-RECORD.
           ...
           WRITE SCORE-RESULT
               INVALID KEY
                   READ SCORE-FILE KEY IS SCR-RESULT-ID
                       INVALID KEY CONTINUE
                       NOT INVALID KEY
                           REWRITE SCORE-RESULT
                               INVALID KEY
                                   DISPLAY 'SCORE REWRITE FAIL'
                               NOT INVALID KEY CONTINUE
                           END-REWRITE
                   END-READ
               NOT INVALID KEY CONTINUE
